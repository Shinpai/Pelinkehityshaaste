...
public class PingContractService
{
    ...
    public static string ABI = @"[{""payable"": false,""stateMutability"": ""nonpayable"",""type"": ""constructor""},{""constant"": false,""inputs"": [{""name"": ""a"",""type"": ""address""}],""name"": ""addAsset"",""outputs"": [],""payable"": false,""stateMutability"": ""nonpayable"",""type"": ""function""},{""constant"": false,""inputs"": [{""name"": ""a"",""type"": ""address""}],""name"": ""takeAsset"",""outputs"": [],""payable"": false,""stateMutability"": ""nonpayable"",""type"": ""function""},{""constant"": true,""inputs"": [],""name"": ""getAssets"",""outputs"": [{""name"": "",""type"": ""address[]""}],""payable"": false,""stateMutability"": ""view"",""type"": ""function""}]";
    ...
    {
        return contract.GetFunction("getAssets");
    }
